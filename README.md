...
Smake (Simple-Make) is a C program that implements a lightweight version of the popular building utility "make". Smake reads from a file composed of rules, and will build program files that are out of date.
